...
{
    public class PlayerPrefsDataStoreTest
    {
        ...
        {
            sut = new PlayerPrefsDataStore(saveFolderPath);
        ...
        [UnityTest]
        public IEnumerator A_PlayerPrefsDataStore_LoadWithExistingFile_WillGetExpectValue() =>
        ...
        [UnityTest]
        public IEnumerator B_PlayerPrefsDataStore_SaveWithData_WillGetExpectValue() =>
        UniTask.ToCoroutine(async () =>
        {
        ...
        [UnityTest]
        public IEnumerator C_PlayerPrefsDataStore_DeleteExistingData_WillNotExist() =>
        UniTask.ToCoroutine(async () =>
        {
        ...
        [UnityTest]
        public IEnumerator D_PlayerPrefsDataStore_Load_FileExists_ReturnNotEmptyString() =>
        UniTask.ToCoroutine(async () =>
        {
            string result = await sut.Load(EXISTING_FILE_NAME);
        ...
        [UnityTest]
        public IEnumerator E_PlayerPrefsDataStore_Load_FileNotExists_ReturnDefaultEmptyString() =>
        UniTask.ToCoroutine(async () =>
        {
            string result = await sut.Load("FILE_NOT_EXTST");

            Assert.AreEqual(result, "");
        });

        [UnityTest]
        public IEnumerator F_PlayerPrefsDataStore_DataSeparation_ShouldNotEqual() =>
        UniTask.ToCoroutine(async () =>
        {
        ...
        [UnityTest]
        public IEnumerator G_PlayerPrefsDataStore_Reentrance_ShouldNotThrow() =>
        UniTask.ToCoroutine(async () =>
        {
            var dataStore = new NonSerializedFileDataStore("NEW_FOLDER");
        ...
        [Test]
        public void H_PlayerPrefsDataStore_GetDataCount_WillGetExpectValue()
        {
        ...
        [UnityTest]
        public IEnumerator I_PlayerPrefsDataStore_LoadMultipleExistingFiles_WillGetExpectValue() =>
        UniTask.ToCoroutine(async () =>
        {
        ...
        [UnityTest]
        public IEnumerator J_PlayerPrefsDataStore_LoadMultipleExistingFilesWithOffset_WillGetExpectValue() =>
        UniTask.ToCoroutine(async () =>
        {
        ...
        [UnityTest]
        public IEnumerator K_PlayerPrefsDataStore_LoadMultipleExistingFilesWithLargeOffset_WillGetNull() =>
        UniTask.ToCoroutine(async () =>
        {
